...
from strategies.volume_contraction_new import (
...
def main():
    ...
    regime_sym = "SPY"
    contracts[regime_sym] = IBKRContractSpec(symbol=regime_sym)   # ✅ 加上 SPY
    ...
    cfg = VolumeContractionConfig(
        universe=universe,
        top_k=5,
        rebalance_every=1,          # 日线策略：每天评估/补票
        signal_lag_bars=1,          # ✅ 避免前视
    ...
    risk_model = ChainRiskManagementModel([
        StopLossRiskModel(stop_loss_pct=0.08),  # 风控层退出
